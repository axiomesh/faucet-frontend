...
const CanvasPage: React.FC = (props) => {
  ...
  return (
    <div className={styles.mask} style={{height: '100vh', minHeight: 872}}>
      <Lottie options={Options} height="100vh" width="100vw" isClickToPauseDisabled={true} />
