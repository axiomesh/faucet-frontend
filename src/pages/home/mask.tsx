...
const CanvasPage: React.FC = (props:any) => {
  const { onCancel, hash, showBtn, loading, err } = props;
  const Options = {
    loop: true,
    autoplay: true,
    ...
    <div className={styles.mask} style={{minHeight: 872}}>
      ...
      <div className={styles.maskText}>
        ...
        {loading ? <div className={styles.fadeIn} style={{textAlign: 'center'}}>
          ...
          <div className={styles.errorSubTitle}>{err}</div>
